...
export const Hero = () => {
  ...
  return (
    <section className="relative flex min-h-screen w-full flex-col overflow-hidden">
      ...
      <div className="c-space relative z-20 mx-auto mt-20 flex w-full max-w-[1200px] flex-col gap-4 sm:mt-36">
      ...
      <div className="c-space absolute bottom-7 left-0 right-0 z-30 mx-auto w-full max-w-[1200px]">
        <Button
          isBeam
